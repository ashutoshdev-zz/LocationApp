...
@SuppressLint("NewApi")
public class ZakoopiImageRender implements GLSurfaceView.Renderer {

	Bitmap bitmap;
	private Context context;

	public ZakoopiImageRender(Context context, Bitmap bitmap) {
	...
	private void initEffect() {
		...
		case 19:
			mEffect = effectFactory.createEffect(EffectFactory.EFFECT_TINT);
			mEffect.setParameter("tint", Color.CYAN);
			break;

		case 20:
			mEffect = effectFactory.createEffect(EffectFactory.EFFECT_TINT);
			mEffect.setParameter("tint", Color.LTGRAY);
			break;
			
		case 21:
			mEffect = effectFactory.createEffect(EffectFactory.EFFECT_TINT);
			mEffect.setParameter("tint", Color.rgb(80, 50, 80));
			break;

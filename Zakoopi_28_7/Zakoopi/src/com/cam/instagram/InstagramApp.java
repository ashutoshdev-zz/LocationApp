...
import com.cam.instagram.InstagramDialog.OAuthDialogListener;
...
public class InstagramApp {
	...
	public void getPostImageUrls(){
		
		try{
			
		 if(mSession.getId()!=null||mSession.getAccessToken()!=null){
